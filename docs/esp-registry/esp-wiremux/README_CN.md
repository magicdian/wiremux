...
该 component 包含 beginner、advanced 和 professional Registry examples。
professional 示例展示 channel 1 line-mode console 输入、channel 2 ESP log
输出、channel 3 telemetry 和 channel 4 UTF-8 文本输出。
